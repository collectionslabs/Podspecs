Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/iMediaSandboxing/XPCKit"
  s.author       = { "Steve Streza" => "stevestreza@gmail.com" }
  s.source       = { :git => "https://github.com/iMediaSandboxing/XPCKit.git", :commit => "dd218a29834322fe50baf4ac6fe00af445c16225" }
  s.platform     = :osx
